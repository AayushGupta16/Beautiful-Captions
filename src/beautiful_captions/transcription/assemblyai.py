...
class AssemblyAIService(TranscriptionService):
    ...
    def __init__(self, api_key: str):
        ...
        aai.settings.api_key = api_key # type: ignore
    ...
    async def transcribe(
        ...
        config = aai.TranscriptionConfig( # type: ignore
    ...
    def _transcribe_sync(self, audio_path: str, config: aai.TranscriptionConfig) -> List[Utterance]: # type: ignore
        """Synchronous implementation that will be run in a separate thread."""
        transcriber = aai.Transcriber(config=config) # type: ignore
